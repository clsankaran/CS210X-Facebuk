...
public class Moment extends Item {
     ...
     * @param name the name that the instance varaible _name, of the super class Item, will be set to.
     * @param image the image that the instance varaible _image, of the super class Item, will be set to.
