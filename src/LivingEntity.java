...
public class LivingEntity extends Item {
	...
	/**
	 * Sets the value of the instance variable _friends to the inputted value
	 * friends.
	 * 
	 * @param friends
	 *            an ArrayList of LivingEntities who are friends with the
	 *            LivingEntity.
	 */
	...
	/**
	 * Sets the value of the instance variable _moments to the inputted value
	 * moments.
	 * 
	 * @param moments
	 *            an ArrayList of Moments which are the moments the LivingEntity
	 *            participated in.
	 */
	...
	public LivingEntity getFriendWithWhomIAmHappiest() {
		...
		for (int i = 0; i < _friends.size(); i++) {
			...
			if (currAmm == 0) { // makes sure it doesn't crash if the friends don't appear in any moments
								// together
				currAvg = 0;
			} else {
	...
	/**
	 * Helper method that filters out all the non-clique sets from an ArrayList of
	 * ArrayLists of LivingEntities.
	 * 
	 * @return an ArrayList of ArrayLists of LivingEntities containing all
	 *         ArrayLists that are Cliques.
	 */
